    ...
    <div className={`min-h-full ${bg}`}>
            ...
            <div className="flex flex-col md:flex-row md:items-start gap-6">
              <div className="flex-1">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                  {[
                    ...
                    { l: "AREA",     v: activeIncident.platform, ic: MapPin },
                  ].map(item => (
              ...
              <div className={`w-full md:w-64 h-48 relative overflow-hidden ${dark ? "bg-obsidian" : "bg-[#E0DBD0]"} border border-signal-red/30 flex-shrink-0`}>
                ...
                <svg className="absolute inset-0 w-full h-full" viewBox="0 0 300 200" preserveAspectRatio="xMidYMid meet">
                  ...
                  <text x="150" y="32" textAnchor="middle" fontSize="6" fill="#F4B942" fillOpacity=".5" fontFamily="JetBrains Mono,monospace">NEAR KENDRIYA VIDYALAYA</text>
                  ...
                  <text x="150" y="87" textAnchor="middle" fontSize="6" fill="#F4B942" fillOpacity=".5" fontFamily="JetBrains Mono,monospace">SECTOR-10,11 DIVIDING ROAD</text>
          ...
          <div className="flex flex-wrap gap-3 items-center">
            ...
            {ack && (
              <span className="font-mono text-[9px] text-safe tracking-widest">
                ● Recognised by AREA_POLICE_001 at {new Date().toLocaleTimeString("en-IN", { hour12: false })}
              </span>
            )}
          </div>
        </div>
      ...
      {showAckConfirm && (
        <Modal
          ...
          msg={`Confirm that INCIDENT #${activeIncident.id} has been recognised. This logs your police station ID and timestamp. Field team must be aware before confirming.`}
            ...
            <div className="p-5">
              ...
              <div className={`h-44 ${dark ? "bg-obsidian" : "bg-[#E0DBD0]"} border border-signal-red/30 relative overflow-hidden grid-bg mb-4`}>
                <div className="absolute" style={{ left: "18%", top: "62%", transform: "translate(-50%,-50%)" }}>
                  ...
                  <div className="absolute bottom-2 right-2 font-mono text-[7.5px] text-signal-red">{activeIncident.location} // AREA POLICE STATION</div>
              </div>
              <div className="space-y-1.5 font-mono text-[9.5px]">
                <div className="flex justify-between"><span className={muted}>COORDINATES</span><span className="text-brass">28.6447°N, 77.2086°E</span></div>
                  <div className="flex justify-between"><span className={muted}>LOCATION</span><span className={text}>{activeIncident.location}</span></div>
                  <div className="flex justify-between"><span className={muted}>POLICE STATION</span><span className={text}>AREA COMMAND</span></div>
              </div>
            </div>
          </div>
        </div>
