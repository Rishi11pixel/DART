  ...
  return (
    <div className={`h-full flex flex-col ${bg} border-r ${bdr} w-[220px] flex-shrink-0`}>
      ...
      <div className="px-4 pt-5 pb-4">
        <div className="flex items-center gap-2.5 mb-0.5">
          ...
          <div>
            ...
            <div className={`font-mono text-[7.5px] tracking-[.15em] uppercase ${muted} mt-0.5`}>POLICE STATION CONTROL</div>
          </div>
        </div>
      ...
      <div className={`px-4 py-2.5 border-t ${bdr} bg-obsidian/40`}>
        ...
        <div className={`font-heading text-[11px] tracking-widest font-semibold ${text}`}>AREA_POLICE_001</div>
        <div className={`font-mono text-[8px] tracking-widest ${muted}`}>Police Station // Area Command</div>
      </div>
