    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-obsidian">
      ...
      <div className="relative flex-1 flex flex-col justify-between p-8 md:p-14 overflow-hidden bg-obsidian">
        ...
        <div className="absolute inset-0 grid-bg opacity-70 pointer-events-none" />
          ...
          {/* SVG background — area response schematic */}
        <svg className="absolute inset-0 w-full h-full opacity-[0.055] pointer-events-none" viewBox="0 0 800 600" fill="none" preserveAspectRatio="xMidYMid meet">
          ...
          <text x="610" y="403" textAnchor="middle" fontSize="10" fill="#F4B942" fontFamily="monospace" letterSpacing="2">DART</text>
          {/* Signal markers */}
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-1">
            ...
            <div>
              ...
              <div className="font-mono text-[8.5px] text-warm-grey tracking-[.18em] uppercase leading-tight mt-0.5">DIGITAL ANOMALY RESPONSE & TRACE SYSTEM</div>
            </div>
          </div>
        ...
        <div className="relative z-10">
          <div className="font-display text-[56px] md:text-[72px] text-ivory leading-[.92] tracking-wide mb-6">
            SECURE THE<br/><span className="text-brass">COMMUNITY.</span><br/>DETECT THE<br/>UNSEEN.
          </div>
        </div>
      </div>
      ...
      <div className="w-full md:w-[420px] flex flex-col justify-center p-8 md:p-12 relative bg-charcoal">
        ...
        <div className="max-w-sm w-full mx-auto">
          <div className="mb-8">
            ...
            <div className="font-mono text-[10px] tracking-[.18em] uppercase text-warm-grey">Area Police Station Control Center</div>
            <div className="h-[1px] bg-brass w-14 mt-3"/>
          </div>

          <form onSubmit={e=>{e.preventDefault();onLogin();}} className="space-y-5">
            {/* Police station ID */}
            <div>
              <label className={`block font-mono text-[9.5px] tracking-[.22em] uppercase mb-2 text-brass`}>POLICE_STATION_ID</label>
              <input type="text" className="input-sentry" placeholder="e.g. AREA_POLICE_001"
            ...
            <div className="flex items-center gap-3">
              <div onClick={()=>setRemember(!remember)}
                className={`w-4 h-4 border cursor-pointer flex items-center justify-center flex-shrink-0 transition-all ${remember?"bg-brass border-brass":"border-warm-grey/30"}`}>
